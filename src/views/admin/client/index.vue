    ...
    <div class="layout-padding">
        <div class="layout-padding-auto layout-padding-view">
            <el-row class="ml10" v-show="showSearch">
                <el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList" ref="queryRef">
                    ...
                    <el-form-item :label="$t('client.clientSecret')" prop="clientSecret">
                        <el-input
                            :placeholder="$t('client.clientSecret')"
                            style="max-width: 180px"
            ...
            >
                ...
                <el-table-column
                    :label="t('client.authorizedGrantTypes')"
                ...
                <el-table-column
                    :label="t('client.accessTokenValidity')"
                    prop="accessTokenValidity"
                    show-overflow-tooltip
                />
                <el-table-column
                    :label="t('client.refreshTokenValidity')"
                ...
                <el-table-column :label="$t('common.action')" width="150">
                    <template #default="scope">
                        <el-button
                            icon="edit-pen"
                            @click="formDialogRef.openDialog(scope.row.clientId)"
                            text
                            type="primary"
                            v-auth="'sys_client_add'"
                            >{{ $t('common.editBtn') }}
