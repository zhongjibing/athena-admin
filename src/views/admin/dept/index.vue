            ...
            <el-row shadow="hover" v-show="showSearch" class="ml10">
                <el-form :model="state.queryForm" ref="queryRef" :inline="true" @keyup.enter="getDataList">
                    <el-form-item prop="deptName" :label="$t('sysdept.name')">
                        <el-input
                            :placeholder="$t('sysdept.inputdeptNameTip')"
            ...
            <el-row>
                <div class="mb8" style="width: 100%">
                    <el-button
                        ...
                        type="primary"
                        class="ml10"
                        @click="deptDialogRef.openDialog('add')"
                        v-auth="'sys_dept_add'"
                    >
                        {{ $t('common.addBtn') }}
                    </el-button>
                ...
                <el-table-column :label="$t('common.action')" show-overflow-tooltip width="250">
                    <template #default="scope">
                        <el-button
                            ...
                            type="primary"
                            icon="folder-add"
                            @click="deptDialogRef.openDialog('add', scope.row?.id)"
                            v-auth="'sys_dept_add'"
                        >
                        ...
                        <el-button
                            ...
                            type="primary"
                            icon="edit-pen"
                            @click="deptDialogRef.openDialog('edit', scope.row?.id)"
