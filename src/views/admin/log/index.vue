            ...
            >
                ...
                <el-table-column :label="$t('common.action')" width="150">
                    <template #default="scope">
                        <el-button
                            icon="view"
                            @click="LogDetailRef.openDialog(scope.row)"
                            size="small"
                            text
                            type="primary"
                        >
...
<script lang="ts" setup>
    ...
    //  table hook
    const { downBlobFile, getDataList, currentChangeHandle, sortChangeHandle, sizeChangeHandle, tableStyle } =
        useTable(state)
