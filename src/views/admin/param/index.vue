            ...
            <el-row class="ml10" v-show="showSearch">
                <el-form :inline="true" :model="state.queryForm" ref="queryRef">
                    <el-form-item :label="$t('param.publicName')" prop="publicName">
                        <el-input
                            :placeholder="$t('param.inputpublicNameTip')"
                    ...
                    <el-form-item :label="$t('param.publicKey')" prop="publicKey">
                        <el-input
                            :placeholder="$t('param.inputpublicKeyTip')"
                            style="max-width: 180px"
            ...
            >
                ...
                <el-table-column :label="$t('common.action')" width="150">
                    <template #default="scope">
                        <el-button
                            icon="edit-pen"
                            @click="formDialogRef.openDialog(scope.row.publicId)"
                            text
                            type="primary"
                            >{{ $t('common.editBtn') }}
                        </el-button>
                        ...
                        <el-tooltip
                            :content="$t('sysdict.deleteDisabledTip')"
