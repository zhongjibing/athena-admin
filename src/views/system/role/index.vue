<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="显示顺序" prop="sortIndex" min-width="80"/>
