<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="字典编码" align="center" prop="id" min-width="80"/>
            ...
            <el-table-column label="字典键值" align="center" prop="dictValue" min-width="160" />
...
function handleDelete(row) {
    ...
    proxy.$modal.confirm('是否确认删除字典编码为"' + dataIds + '"的数据项？').then(function () {
