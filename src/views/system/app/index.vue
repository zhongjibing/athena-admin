<template>
   <div class="app-container">
       ...
       <el-table v-loading="loading" :data="clients" @selection-change="handleSelectionChange">
           ...
           <el-table-column label="应用名" align="center" key="clientName" prop="clientName" min-width="120" :show-overflow-tooltip="true"/>
           <el-table-column label="授权范围" align="center" key="scopes" prop="scopes" min-width="180" :show-overflow-tooltip="true"/>
       ...
       <el-dialog title="应用详情" v-model="openView" width="700px" destroy-on-close>
           <el-form :model="form" label-width="120px">
               <el-row>
                   ...
                   <el-col :span="24">
                       <el-form-item label="授权方式：">{{ parseGrantTypeLabel(form.authorizationGrantTypes) }}</el-form-item>
                   </el-col>
                   <el-col :span="24">
                   ...
                   <el-col :span="24">
                       <el-form-item label="重定向地址：">
                           <span style="white-space: pre-line">{{ form.redirectUris && form.redirectUris.replaceAll(',', '\n') }}</span>
                       </el-form-item>
                   </el-col>
                   <el-col :span="24">
                       <el-form-item label="状态：">{{ selectDictLabel(sys_normal_disable, form.status) }}</el-form-item>
                   </el-col>
                   <el-col :span="24">
...
function handleStatusChange(row) {
    ...
    proxy.$modal.confirm('确认要' + text + ' "' + row.clientName + '" 应用吗?').then(function () {
...
function handleResetPwd(row) {
    proxy.$prompt('请输入"' + row.clientName + '"的新密码', "提示", {
