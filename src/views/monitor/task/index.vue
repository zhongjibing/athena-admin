<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['monitor:task:add']"
                    >新增</el-button
                >
            </el-col>
            <el-col :span="1.5">
            ...
            <el-col :span="1.5">
                <el-button type="info" plain icon="Operation" @click="handleJobLog" v-hasPermi="['monitor:task:logs']"
                    >日志</el-button
                >
            </el-col>
            ...
            <el-table-column label="操作" align="center" width="360" class-name="small-padding fixed-width">
                <template #default="scope">
                    ...
                    <el-tooltip
                        ...
                        placement="top"
                        effect="light"
                        :visible="toolTips.view[scope.row.id]"
                    >
                        <el-button
                            type="primary"
                            link
                    ...
                    <el-col :span="12">
                        <el-form-item label="状态">
                            <el-radio-group v-model="form.status">
                                <el-radio v-for="dict in sys_task_status" :key="dict.value" :label="dict.value">{{
                                    dict.label
                                }}</el-radio>
                            </el-radio-group>
                        </el-form-item>
                ...
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="任务状态：">{{
                            selectDictLabel(sys_task_status, form.status)
                        }}</el-form-item>
                    </el-col>
                    <el-col :span="12">
...
<script setup name="Task">
    ...
    function handleDelete(row) {
        ...
        proxy.$modal
            .confirm('是否确认删除定时任务编号为"' + taskIds + '"的数据项?')
            .then(function () {
