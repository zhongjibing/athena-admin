    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
            ...
            <el-form-item label="任务组名" prop="taskGroup" v-if="!queryParams.taskId">
                <el-select v-model="queryParams.taskGroup" placeholder="请选择任务组名" clearable style="width: 240px">
                    <el-option
                ...
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="任务分组：">{{
                            selectDictLabel(sys_task_group, form.taskGroup)
                        }}</el-form-item>
                    ...
                    <el-col :span="24">
                        <el-form-item label="异常信息：" v-if="form.status === '1'" style="white-space: pre-line">{{
                            form.exceptionInfo
                        }}</el-form-item>
                    </el-col>
                </el-row>
