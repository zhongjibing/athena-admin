<template>
    <div class="app-container">
        ...
        <el-table ref="operlogRef" v-loading="loading" :data="operlogList">
            ...
            <el-table-column label="请求地址" align="left" prop="requestUrl" min-width="210" :show-overflow-tooltip="true"/>
            ...
            <el-table-column label="操作地址" align="center" prop="requestIp" min-width="120" :show-overflow-tooltip="true"/>
            <el-table-column label="操作地点" align="center" prop="requestLocation" min-width="180" :show-overflow-tooltip="true"/>
